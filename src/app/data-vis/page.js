...
export default function PakistanMap() {
  ...
  return (
    ...
    <>
      <h1 className="text-4xl md:text-5xl font-bold mb-6 text-center">Map</h1>
      <section className="max-w-5xl w-full h-screen flex justify-center">
        <svg
          ref={svgRef}
      ...
      {/* Blog Text Section */}
    <section className="max-w-5xl w-full prose prose-invert text-lg leading-relaxed">
      <h2 className="text-2xl font-semibold mt-5 mb-4">Climate and Cities</h2>
      <p>
        This map shows different cities with their average climate data
        represented visually. You can interact with the map to explore
        different regions and compare temperature and rainfall trends.
      </p>
      <p>
        Over time, we plan to expand this visualization to include more
        granular data, such as seasonal variations and long-term climate
        changes.
      </p>
    </section>
    </>
